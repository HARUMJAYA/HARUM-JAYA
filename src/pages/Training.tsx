    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-[#f39c12] text-white py-16">
        <div className="container mx-auto max-w-7xl px-4">
          <h1 className="text-4xl font-bold italic uppercase tracking-tighter">Pusat Pelatihan & Sertifikasi</h1>
          <p className="mt-2 text-gray-100">Program SKK, Bimtek, dan Pengembangan Kompetensi SDM Konstruksi</p>
        </div>
      </div>
            ...
            {trainings.map((t) => (
              <div key={t.id} className="group border-2 border-gray-50 hover:border-orange-500 transition-colors p-1">
                ...
                <div className="p-6 text-center">
                  <span className="text-[10px] font-bold text-orange-500 uppercase tracking-widest mb-2 block">{t.category}</span>
                  <h3 className="font-bold text-lg text-gray-800 uppercase italic line-clamp-1">{t.title}</h3>
                </div>
              </div>
            ))}
          </div>
