    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-[#f8f9fa] py-20 border-b">
        <div className="container mx-auto max-w-4xl text-center px-4">
          <h1 className="text-5xl font-bold italic text-gray-800 tracking-tighter uppercase mb-6">Profil Perusahaan</h1>
          <div className="w-20 h-1.5 bg-[#4834d4] mx-auto mb-8"></div>
          <p className="text-gray-600 text-lg font-light leading-relaxed whitespace-pre-line max-w-3xl mx-auto">
            {data.about_company || "Membangun impian Anda menjadi kenyataan melalui keunggulan teknik dan dedikasi profesional."}
          </p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center" id="vision">
                ...
                <div className="space-y-12">
                  <div className="relative pl-8 border-l-4 border-[#4834d4]">
                    ...
                    <p className="text-gray-600 leading-relaxed italic">
                      {data.vision || "Menjadi perusahaan konstruksi terdepan di Indonesia."}
                    </p>
                  </div>
                  <div className="relative pl-8 border-l-4 border-[#2c3e50]">
                    ...
                    <p className="text-gray-600 leading-relaxed whitespace-pre-line">
                      {data.mission || "Memberikan layanan berkualitas tinggi dan inovatif."}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-12 rounded-2xl" id="awards">
                ...
                <p className="text-gray-600 leading-loose whitespace-pre-line">
                  {data.awards || "Data penghargaan sedang diperbarui."}
                </p>
              </div>
            </div>
